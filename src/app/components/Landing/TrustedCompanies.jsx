...
export const TrustedCompanies = () => {
  return (
    <div className='flex flex-col items-center justify-center px-4 py-12 md:py-16 mb-48 mt-80'>
      <h1 className='text-[34px] md:text-[56px] leading-16 font-semibold mb-8 md:mb-20'>
        Trusted Companies
      </h1>
