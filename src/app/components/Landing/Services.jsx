...
export const Services = () => {
  ...
  return (
    <div className="text-center px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div className="w-full md:w-1/2 lg:w-2/3 xl:w-[45%] mx-auto flex flex-col gap-4 sm:gap-6 md:gap-8 text-center pt-6 sm:pt-8">
        <h2 className="text-[30px] md:text-[56px] font-[600] leading-snug mx-2 md:mx-0">
          What We Do - Crafted 
          <br/> for Your Success
        </h2>
        <p className="text-base md:text-[18px] font-[400] mx-2 md:mx-0 desktop-br leading-6 sm:leading-7  text-gray-600">
